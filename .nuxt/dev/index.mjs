...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/h3@1.15.3/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@vue+shared@3.5.13/node_modules/@vue/shared/dist/shared.cjs.js';
import dayjs from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/dayjs@1.11.19/node_modules/dayjs/dayjs.min.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/vue-bundle-renderer@2.1.1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/vue@3.5.13_typescript@5.8.3/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/ofetch@1.4.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/node-mock-http@1.0.0/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/unstorage@1.16.0_db0@0.3.2_ioredis@5.6.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/unstorage@1.16.0_db0@0.3.2_ioredis@5.6.1/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/youch-core@0.3.2/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/youch@4.1.0-beta.7/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/source-map@0.7.4/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/devalue@5.1.1/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/vue@3.5.13_typescript@5.8.3/node_modules/vue/index.mjs';
import BaseStyle from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primevue+core@4.3.4_vue@3.5.13_typescript@5.8.3_/node_modules/@primevue/core/base/style/index.mjs';
import BaseComponentStyle from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primevue+core@4.3.4_vue@3.5.13_typescript@5.8.3_/node_modules/@primevue/core/basecomponent/style/index.mjs';
import { style } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/autocomplete/index.mjs';
import { isNotEmpty, isEmpty } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+utils@0.5.3/node_modules/@primeuix/utils/object/index.mjs';
import { style as style$1 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/cascadeselect/index.mjs';
import { style as style$2 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/checkbox/index.mjs';
import { style as style$3 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/checkboxgroup/index.mjs';
import { style as style$4 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/colorpicker/index.mjs';
import { style as style$5 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/datepicker/index.mjs';
import { style as style$6 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/floatlabel/index.mjs';
import { style as style$7 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/iconfield/index.mjs';
import { style as style$8 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/iftalabel/index.mjs';
import { style as style$9 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/inputchips/index.mjs';
import { style as style$a } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/inputgroup/index.mjs';
import { style as style$b } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/inputnumber/index.mjs';
import { style as style$c } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/inputotp/index.mjs';
import { style as style$d } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/inputtext/index.mjs';
import { style as style$e } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/knob/index.mjs';
import { style as style$f } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/listbox/index.mjs';
import { style as style$g } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/multiselect/index.mjs';
import { style as style$h } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/password/index.mjs';
import { style as style$i } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/radiobutton/index.mjs';
import { style as style$j } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/radiobuttongroup/index.mjs';
import { style as style$k } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/rating/index.mjs';
import { style as style$l } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/select/index.mjs';
import { style as style$m } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/selectbutton/index.mjs';
import { style as style$n } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/slider/index.mjs';
import { style as style$o } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/textarea/index.mjs';
import { style as style$p } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/togglebutton/index.mjs';
import { style as style$q } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/toggleswitch/index.mjs';
import { style as style$r } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/treeselect/index.mjs';
import { style as style$s } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/button/index.mjs';
import { style as style$t } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/buttongroup/index.mjs';
import { style as style$u } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/speeddial/index.mjs';
import { style as style$v } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/splitbutton/index.mjs';
import { style as style$w } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/datatable/index.mjs';
import { style as style$x } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/dataview/index.mjs';
import { style as style$y } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/orderlist/index.mjs';
import { style as style$z } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/organizationchart/index.mjs';
import { style as style$A } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/paginator/index.mjs';
import { style as style$B } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/picklist/index.mjs';
import { style as style$C } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/tree/index.mjs';
import { style as style$D } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/treetable/index.mjs';
import { style as style$E } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/timeline/index.mjs';
import { style as style$F } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/virtualscroller/index.mjs';
import { style as style$G } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/accordion/index.mjs';
import { style as style$H } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/card/index.mjs';
import { style as style$I } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/divider/index.mjs';
import { style as style$J } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/fieldset/index.mjs';
import { style as style$K } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/panel/index.mjs';
import { style as style$L } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/scrollpanel/index.mjs';
import { style as style$M } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/splitter/index.mjs';
import { style as style$N } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/stepper/index.mjs';
import { style as style$O } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/tabview/index.mjs';
import { style as style$P } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/tabs/index.mjs';
import { style as style$Q } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/toolbar/index.mjs';
import { style as style$R } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/confirmdialog/index.mjs';
import { style as style$S } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/confirmpopup/index.mjs';
import { style as style$T } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/dialog/index.mjs';
import { style as style$U } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/drawer/index.mjs';
import { style as style$V } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/popover/index.mjs';
import { style as style$W } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/fileupload/index.mjs';
import { style as style$X } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/breadcrumb/index.mjs';
import { style as style$Y } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/contextmenu/index.mjs';
import { style as style$Z } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/dock/index.mjs';
import { style as style$_ } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/menu/index.mjs';
import { style as style$$ } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/menubar/index.mjs';
import { style as style$10 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/megamenu/index.mjs';
import { style as style$11 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/panelmenu/index.mjs';
import { style as style$12 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/steps/index.mjs';
import { style as style$13 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/tabmenu/index.mjs';
import { style as style$14 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/tieredmenu/index.mjs';
import { style as style$15 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/message/index.mjs';
import { style as style$16 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/inlinemessage/index.mjs';
import { style as style$17 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/toast/index.mjs';
import { style as style$18 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/carousel/index.mjs';
import { style as style$19 } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/galleria/index.mjs';
import { style as style$1a } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/image/index.mjs';
import { style as style$1b } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/imagecompare/index.mjs';
import { style as style$1c } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/avatar/index.mjs';
import { style as style$1d } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/badge/index.mjs';
import { style as style$1e } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/blockui/index.mjs';
import { style as style$1f } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/chip/index.mjs';
import { style as style$1g } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/inplace/index.mjs';
import { style as style$1h } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/metergroup/index.mjs';
import { style as style$1i } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/overlaybadge/index.mjs';
import { style as style$1j } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/scrolltop/index.mjs';
import { style as style$1k } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/skeleton/index.mjs';
import { style as style$1l } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/progressbar/index.mjs';
import { style as style$1m } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/progressspinner/index.mjs';
import { style as style$1n } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/tag/index.mjs';
import { style as style$1o } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/terminal/index.mjs';
import FormStyle from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primevue+forms@4.3.4_vue@3.5.13_typescript@5.8.3_/node_modules/@primevue/forms/form/style/index.mjs';
import FormFieldStyle from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primevue+forms@4.3.4_vue@3.5.13_typescript@5.8.3_/node_modules/@primevue/forms/formfield/style/index.mjs';
import { style as style$1p } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/tooltip/index.mjs';
import { style as style$1q } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styles@1.1.1/node_modules/@primeuix/styles/ripple/index.mjs';
import { Theme } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/@primeuix+styled@0.6.1/node_modules/@primeuix/styled/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/unhead@2.0.8/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/unhead@2.0.8/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/gwen/Documents/dev/tpg-app/node_modules/.pnpm/unhead@2.0.8/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/gwen/Documents/dev/tpg-app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/gwen/Documents/dev/tpg-app","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/gwen/Documents/dev/tpg-app/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/gwen/Documents/dev/tpg-app/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/gwen/Documents/dev/tpg-app/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/gwen/Documents/dev/tpg-app/.data/kv"}));
...
const rootDir = "/Users/gwen/Documents/dev/tpg-app";
...
const _DvkPuprDIfvaewXAPAdGsQykN8ANJmQMhR22MyeHrI = (nitroApp) => {
...
const _5zd1IadIqupWXffygaQu1jt7ys9by4yx4AXASoqh60 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _DvkPuprDIfvaewXAPAdGsQykN8ANJmQMhR22MyeHrI,
_5zd1IadIqupWXffygaQu1jt7ys9by4yx4AXASoqh60
];
...
const getServerEntry = () => import('file:///Users/gwen/Documents/dev/tpg-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/gwen/Documents/dev/tpg-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_gJh2QJ = () => Promise.resolve().then(function () { return departures_get$1; });
const _lazy_354b9w = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/departures', handler: _lazy_gJh2QJ, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_354b9w, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_354b9w, lazy: true, middleware: false, method: undefined }
];
...
const departures_get = defineEventHandler(async () => {
  ...
  try {
    ...
    const departures = data.stationboard.map((dep) => {
      ...
      const real = ((_a = dep.stop.prognosis) == null ? void 0 : _a.departure) ? dayjs(dep.stop.prognosis.departure) : planned;
...
const departures_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: departures_get
});
